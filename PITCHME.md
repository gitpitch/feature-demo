...
### What does a holistic user experience design process look like?
<br>
Sotware Development Processes

---?image=assets/img/waterfall_model.png&color=white&size=auto 90%
...
- Open entire project must be completed to fully test
...
@div[activity-details]
We believe that our customers will find the "add to cart" button because it is highly visible We believe that our customers will be able to complete the checkout process because it is very simple
@divend
...
- Common factors for consideration are
    ...
    - Task structure (e.g. complexity, reptition)
    - Motivation/Attitude
- Assign a priority to each goal (e.g. 1-3)
    - @size[0.8em](Could be specifically measured, but overall usability assessment e.g. SUS is usually sufficient)
